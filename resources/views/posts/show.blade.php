                    ...
                    <address class="flex items-center mb-6 not-italic">
                        <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                            ...
                            <div>
                                ...
                                <p class="text-base text-gray-500 dark:text-gray-400"><time title="February 8th, 2022">{{ $post->created_at}}</time></p>
                            </div>
                        </div>
                    </address>
                    <!-- Edit post button -->
            ...
            <div class="mx-auto max-w-screen-md sm:text-center">
                ...
                <form action="#">
                    <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                        ...
                        <div>
                            <button type="submit" class="py-3 px-5 w-full text-sm font-medium text-center hover:underline dark:text-gray-400 rounded-lg border cursor-pointer bg-primary-700 border-primary-600 sm:rounded-none sm:rounded-r-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Subscribe</button>
                        </div>
                    </div>
